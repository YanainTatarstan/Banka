...
print = list = [i for i in range(20, 240) if i % 20 == 0 or i % 21 == 0]; ('Список чисел кратных 20 или 21 в пределах 20..240: ', list)
...
n = input('Какое слово хотите повторять? - ').split(' ')
count = 1
for i in cycle(n):
    if count > 10:
        break
